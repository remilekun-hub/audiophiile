...
function Nav() {
  return (
    <section className="px-5 xs:px-6 md:px-10 lg:px-5">
      <div className="mx-auto  max-w-screen-lg  pt-20 md:pt-24 pb-14 md:pb-24 flex flex-col md:flex-row space-y-16 md:space-y-0 md:space-x-4 lg:space-x-5">
